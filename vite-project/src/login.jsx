...
const Login = () => {
  return (
    <div>
      <div className="bg-slate-800 norder border-slate-400 rounded-md p-8 shadow-lg backdrop-filter background-blur-sm bg-opacity-30 relative">
        ...
        <form action="">
            ...
            <div>
                <div className='relative my-4'>
                    <input type="password" className="block w-72 py-2.3 px-0 text-sm text-white bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:focus:boder-blue-500 focus:outline-none focus:ring-0 focus:text-white focus:border-blue-600 peer" placeholder=""/>
                ...
                <button className="w-full mb-4 text-[18px] at -6 rounded-full bg-white text-emerald-800 hover:bg-emerald-600 hover:text-white py-2 transition-colors duration-300" type="submit">Login</button>
                <div>
